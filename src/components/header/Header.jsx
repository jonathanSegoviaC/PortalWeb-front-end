...
const Header = () => {
    ...
    return (
        <div
            className={`header ${isNavExpanded.isSmall && !isExpanded ? 'expanded' : isExpanded && isNavExpanded.reset ? 'expanded' : ''
                ...
                <div className="main-logo d-lg-block d-none">
                    <div className="logo-big">
                        <Link to="/dashboard">
                            ...
                            <img src={`${isLightTheme? "/assets/images/logo_myDealer_final2.png":"/assets/images/logo_myDealer_final2.png"}`} alt="Logo"/>
                    ...
                    <div className="logo-small">
                        <Link to="/dashboard">
                            ...
                            <img src="/assets/images/logo_myDealer_final2.png" alt="Logo"/>
