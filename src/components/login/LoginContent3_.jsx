...
const LoginContent3 = () => {
    ...
    const [isLightTheme, setIsLightTheme] = useState('assets/images/logo-big.png');
                            ...
                            <form>
                                ...
                                <div className="input-group mb-20">
                                    ...
                                    <Link
                                        ...
                                        onClick={() => {
                                            var data = passwordVisible;
                                            data === "password" ? data = "text" : data = "password";
